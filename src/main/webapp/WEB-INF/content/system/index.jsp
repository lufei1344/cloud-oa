...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    ...
    <script type="text/javascript" src="${ctx}/scripts/hplus/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script type="text/javascript" src="${ctx}/scripts/hplus/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script type="text/javascript" src="${ctx}/scripts/hplus/js/plugins/layer/layer.js"></script>
    <script type="text/javascript" src="${ctx}/scripts/hplus/js/hplus.min.js"></script>
    <script type="text/javascript" src="${ctx}/scripts/hplus/js/contabs.min.js"></script>
    <script type="text/javascript" src="${ctx}/scripts/hplus/js/plugins/pace/pace.min.js"></script>
</body>
