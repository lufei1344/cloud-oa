...
<head>
	...
	<body>
		...
		<caption style="text-align: center;"><h2>资源管理</h2></caption>
				<tr>
				...
				<tr>
					...
					<td>
						<div class="col-sm-6">
						<textarea type="text" class="form-control" id="source" name="source"
						 >${resource.source }</textarea>
						</div>	
					</td>
				</tr>
 				<tr>
					...
					<td>
						...
						<input type="text" id="parentMenuName" readonly="readonly" name="parentMenuName" class="form-control" value="${resource.menu.name }">
						<input type='button' class='btn btn-sm btn-primary' value='选择菜单' id="selectMenu" onclick="openDialog()"/>
						</div>
					</td>
				</tr>
			</table>
