			...
			<form id="miniForm">
				<table class="table-detail" cellspacing="1" cellpadding="1">
					...
					<tr>
						...
						<th>初始显示用户组*</th>
						<td>
							<input class="mini-checkbox" name="initlogingroup" id="initlogingroup" value="true"/>是
						</td>
					</tr>
					<tr id="dimRow" style="display:none">
						...
						<td colspan="3">
							 <input id="dimid" name="dimid" class="mini-combobox" style="width:150px;" textField="name" valueField="dimId" 
						        url="${ctxPath}/sys/org/osDimension/jsonAll.do"/>
						</td>
					</tr>
					<tr>
						<th>
		...
		dialog.onok = function (){
	        ...
	        if( !oNode ) {
		        ...
		        try {
		            ...
		            oNode.setAttribute('class','mini-group mini-buttonedit icon-group-button rxc');
