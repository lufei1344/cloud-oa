...
<head>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	 	<title>下拉列表-mini-combobox</title>
			...
			<form id="miniForm">
				<table class="form-table" cellpadding="1" cellspacing="0">
					...
					<tr>
						...
						<td colspan="3" class="form-table-td">
							<input id="popupwidth" name="popupwidth" class="mini-spinner" style="width:80px" value="150" minValue="0" maxValue="1200"/>
