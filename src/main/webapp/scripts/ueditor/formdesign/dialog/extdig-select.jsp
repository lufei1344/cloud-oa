...
<body>
	<div style="width:100%;text-align: center">
		<div style="margin-left:auto;margin-right: auto;padding:5px;">
			...
			<input type="hidden" name="showtype" id="showtype" value="select"/>
			<input type="hidden" name="exttype" id="exttype" value=""/>
				<table class="table table-bordered" >
					<caption style="text-align:center"><h2>下拉选择框属性配置</h2></caption>
					<tr>
						<td align="right">
	...
	<script type="text/javascript">
		...
		//编辑的控件的值
		var oNode = null,
		nodeInfo = {thePlugins : 'extdig-select',tag:"select",type:"select"};
		//加载初始化
