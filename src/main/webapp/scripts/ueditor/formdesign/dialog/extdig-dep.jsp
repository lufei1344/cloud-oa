			...
			<form id="miniForm">
				<table class="table-detail" cellspacing="1" cellpadding="1">
					...
					<tr>
						<th>初始显示部门*</th>
						<td colspan="3">
							<input class="mini-checkbox" name="initlogindep" id="initlogindep" value="true"/>是
						</td>
					</tr>
		...
		dialog.onok = function (){
	        ...
	        if( !oNode ) {
		        ...
		        try {
		            ...
		            oNode.setAttribute('class','mini-dep mini-buttonedit icon-dep-button rxc');
