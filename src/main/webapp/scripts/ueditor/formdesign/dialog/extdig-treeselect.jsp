		...
		<div style="margin-left: auto; margin-right: auto; padding: 5px;">
			<form id="miniForm">
				<table class="table-detail" cellspacing="0" cellpadding="1">
					<caption>下拉树选择控件</caption>
					<tbody>
					<tr>
						<th>字段备注*</th>
						<td><input class="mini-textbox" name="label" required="true" vtype="maxLength:100,chinese" style="width: 90%" emptytext="请输入字段备注" /></td>
						<th>字段标识*</th>
						<td><input name="name" class="mini-treeselect" url="${ctxPath}/bpm/bm/bpmFormModel/getModelAttTree.do?modelId=${param['modelId']}" multiSelect="false" valueFromSelect="false" emptytext="请输入字段标识，为英文开头或与数字组合" style="width: 90%" textField="key" valueField="key" parentField="parentId" allowInput="true" onvalidation="onKeyValidation" required="true" onvaluechanged="fieldChange" showRadioButton="true" showFolderCheckBox="false" /></td>
					</tr>
					<tr>
						<th >值来源</th>
						<td colspan="3" >
					...
					<tr id="selfSQL_row" style="display: none">
						...
						<td colspan="3" style="padding: 5px;" ><input id="sql" name="sql" value="${sysDbSql.key}"  text="${sysDbSql.sql}"  style="width: 250px;" class="mini-buttonedit" onbuttonclick="onButtonEdit_sql" />&nbsp;&nbsp;&nbsp;&nbsp;文本字段:<input id="sql_textfield" name="sql_textfield" class="mini-combobox" style="width: 100px;"  data=""  valueField="field"  textField="header"  required="true" allowInput="false" enabled="false" /> &nbsp;-&nbsp;数值字段:<input id="sql_valuefield" name="sql_valuefield" class="mini-combobox" style="width: 100px;" valueField="field"  textField="header"  value="" required="true"
							allowInput="false" enabled="false" />&nbsp;-&nbsp;父节点字段:<input id="sql_parentfield" name="sql_parentfield" class="mini-combobox" style="width: 100px;" valueField="field"  textField="header"  value="" required="true" allowInput="false" enabled="false" /></td>
					</tr>
					<tr>
						<th>必填*</th>
					...
					<tr>
						...
						<th id="expand_settings_label" style="display: none;">展开设置(注：0展开第一级节点，以此类推。)</th>
