			...
			<form id="miniForm">
				<table class="table-detail" cellspacing="1" cellpadding="1">
					...
					<tr>
						...
						<td colspan="3">
							<input class="mini-timespinner" name="value" format="HH:mm" style="width:90%"/>
						</td>
					</tr>
					<tr>
						<th>
		...
		dialog.onok = function (){
		    ...
		    if( !oNode ) {
		        try {
		            ...
		            oNode.setAttribute('class','mini-timespinner rxc');
		    ...
		    for(var key in formData){
		    	if(key=='value'){
		    		oNode.setAttribute(key,mini.formatDate(formData[key],'HH:mm'));
		    	}else{
